...
(*Two agents: agent a, agent b*)
consts 
  Rela::"i\<Rightarrow>i\<Rightarrow>bool" (infixr "Ra" 70) (*Accessibility relation agent a, judicial authority or by an independent administrative authority of Member State.*)  
  Relb::"i\<Rightarrow>i\<Rightarrow>bool" (infixr "Rb" 70) (*Accessibility relation agent b, Member state.*) 
 ...
 (*stit operators for a and b, no meaning assigned*)
  ...
  stitc::"\<sigma>\<Rightarrow>\<sigma>" (*c sees to it that*)
  stitd::"\<sigma>\<Rightarrow>\<sigma>" (*d sees to it that*)

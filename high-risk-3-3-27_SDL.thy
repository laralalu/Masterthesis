...
lemma "\<lfloor>\<^bold>\<circle>l<\<^bold>\<not>((stit l (corrective_action_taken x)) \<^bold>\<or> (stit l (corrective_action_taken_by_resp_agent x)))>\<rfloor>\<^sub>l" by (simp add: A1 AX F1)

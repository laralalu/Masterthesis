theory CJ_DDL_agents_Tests imports DDL_agents           (* Christoph Benzmüller, Ali Farjami, Xavier Parent, 2020  *)
...
lemma C_13_a: "\<lfloor>\<^bold>\<box>\<^sub>aA \<^bold>\<rightarrow> (\<^bold>\<not>\<^bold>O\<^sub>a ob av A \<^bold>\<and> \<^bold>\<not>\<^bold>O\<^sub>a ob av (\<^bold>\<not>A))\<rfloor>"  by (metis (full_types) ax_5a ax_5b)
lemma C_13_b: "\<lfloor>\<^bold>\<box>\<^sub>pA \<^bold>\<rightarrow> (\<^bold>\<not>\<^bold>O\<^sub>p ob pv A \<^bold>\<and> \<^bold>\<not>\<^bold>O\<^sub>p ob pv (\<^bold>\<not>A))\<rfloor>"   by (metis (full_types) ax_5a ax_5b) 
lemma C_14_a: "\<lfloor>\<^bold>\<box>\<^sub>a(A \<^bold>\<leftrightarrow> B) \<^bold>\<rightarrow> (\<^bold>O\<^sub>a ob av A \<^bold>\<leftrightarrow> \<^bold>O\<^sub>a ob av B)\<rfloor>"  by (metis ax_5b)
lemma C_14_b: "\<lfloor>\<^bold>\<box>\<^sub>p(A \<^bold>\<leftrightarrow> B) \<^bold>\<rightarrow> (\<^bold>O\<^sub>p ob pv A \<^bold>\<leftrightarrow> \<^bold>O\<^sub>p ob pv B)\<rfloor>"  by (metis ax_5b)

(* Relationship between "\<^bold>O\<^sub>,\<^bold>O\<^sub>a,\<^bold>O\<^sub>p,\<^bold>\<box>\<^sub>a,\<^bold>\<box>\<^sub>p" *)
lemma C_15_a: "\<lfloor>(\<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<box>\<^sub>aA \<^bold>\<and> \<^bold>\<diamond>\<^sub>aB \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(\<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>a ob av B\<rfloor>"  using ax_5e by blast
lemma C_15_b: "\<lfloor>(\<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<box>\<^sub>pA \<^bold>\<and> \<^bold>\<diamond>\<^sub>pB \<^bold>\<and> \<^bold>\<diamond>\<^sub>p(\<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>p ob pv B\<rfloor>"  using ax_5e by blast
...
lemma res_II_4_1_a_2: "\<lfloor>(\<^bold>\<diamond>\<^sub>p(A \<^bold>\<and> B \<^bold>\<and> C) \<^bold>\<and> \<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>O ob \<^bold>\<langle>C\<^bold>|A\<^bold>\<rangle>) \<^bold>\<rightarrow> \<^bold>O ob \<^bold>\<langle>(B \<^bold>\<and> C)\<^bold>|A\<^bold>\<rangle>\<rfloor>"  using C_3  by auto
...
lemma res_II_4_1_a_4: "\<lfloor>\<^bold>\<diamond>\<^sub>p(\<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle>) \<^bold>\<rightarrow> \<^bold>\<box>\<^sub>p(\<^bold>O ob \<^bold>\<langle>B\<^bold>|(A \<^bold>\<and> B)\<^bold>\<rangle>)\<rfloor>"  by (smt ax_5a ax_5b ax_5e)
lemma res_II_4_1_a_5: "\<lfloor>(\<^bold>\<diamond>\<^sub>p(A \<^bold>\<and> B \<^bold>\<and> C) \<^bold>\<and> \<^bold>O ob \<^bold>\<langle>C\<^bold>|A\<^bold>\<rangle>) \<^bold>\<rightarrow> \<^bold>O ob \<^bold>\<langle>C\<^bold>|(A \<^bold>\<and> B)\<^bold>\<rangle>\<rfloor>"  by (smt ax_5a ax_5b ax_5e)
...
lemma obs_II_4_2_1: "\<lfloor>(\<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<and> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<and> \<^bold>\<not>B)) \<^bold>\<rightarrow> (\<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<rightarrow> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(\<^bold>\<not>(A \<^bold>\<rightarrow> B)))\<rfloor>"  by blast
...
lemma obs_II_4_2_3: "\<lfloor>(\<^bold>O ob \<^bold>\<langle>(A \<^bold>\<rightarrow> B)\<^bold>|\<^bold>\<top>\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<box>\<^sub>a\<^bold>\<top> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<rightarrow> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(\<^bold>\<not>(A \<^bold>\<rightarrow> B))) \<^bold>\<rightarrow> \<^bold>O\<^sub>a ob av (A \<^bold>\<rightarrow> B)\<rfloor>"  by (smt ax_5e)
lemma obs_II_4_2_4: "\<lfloor>\<^bold>\<box>\<^sub>a\<^bold>\<top>\<rfloor>"  by simp
lemma obs_II_4_2_5: "\<lfloor>(\<^bold>O ob \<^bold>\<langle>(A \<^bold>\<rightarrow> B)\<^bold>|\<^bold>\<top>\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<rightarrow> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(\<^bold>\<not>(A \<^bold>\<rightarrow> B))) \<^bold>\<rightarrow> \<^bold>O\<^sub>a ob av (A \<^bold>\<rightarrow> B)\<rfloor>"  by (smt ax_5e)
lemma obs_II_4_2_6: "\<lfloor>(\<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<and> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<and> \<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>a ob av (A \<^bold>\<rightarrow> B)\<rfloor>"   by (simp add: II_3_1)  
lemma obs_II_4_2_6_p: "\<lfloor>(\<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>p(A \<^bold>\<and> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>p(A \<^bold>\<and> \<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>p ob pv (A \<^bold>\<rightarrow> B)\<rfloor>"   by (simp add: II_3_1)  

lemma Oa_C: "\<lfloor>\<^bold>\<diamond>\<^sub>a(A \<^bold>\<and> B) \<^bold>\<and> \<^bold>O\<^sub>a ob av A \<^bold>\<and> \<^bold>O\<^sub>a ob av B \<^bold>\<rightarrow>  \<^bold>O\<^sub>a ob av (A \<^bold>\<and> B)\<rfloor>" using ax_5c by auto
lemma Op_C: "\<lfloor>\<^bold>\<diamond>\<^sub>p(A \<^bold>\<and> B) \<^bold>\<and> \<^bold>O\<^sub>p ob pv A \<^bold>\<and> \<^bold>O\<^sub>p ob pv B \<^bold>\<rightarrow>  \<^bold>O\<^sub>p ob pv (A \<^bold>\<and> B)\<rfloor>" using ax_5c by auto
lemma Oa_DD: "\<lfloor>(\<^bold>O\<^sub>a ob av A \<^bold>\<and> \<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a(A \<^bold>\<and> B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>a ob av (A \<^bold>\<and> B)\<rfloor>" using ax_5b ax_5c obs_II_4_2_6 by smt 
declare [[smt_timeout=300]]
lemma Op_DD: "\<lfloor>(\<^bold>O\<^sub>p ob pv A \<^bold>\<and> \<^bold>O ob \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>p(A \<^bold>\<and> B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>p ob pv (A \<^bold>\<and> B)\<rfloor>" using ax_5b ax_5c obs_II_4_2_6_p by smt
...
lemma dC_13_b: "\<lfloor>\<^bold>\<box>\<^sub>p pvd A \<^bold>\<rightarrow> (\<^bold>\<not>\<^bold>O\<^sub>p obd pvd A \<^bold>\<and> \<^bold>\<not>\<^bold>O\<^sub>p ob pvd (\<^bold>\<not>A))\<rfloor>" using C_2 by blast 
...
(* Relationship between "\<^bold>O\<^sub>,\<^bold>O\<^sub>a,\<^bold>O\<^sub>p,\<^bold>\<box>\<^sub>a,\<^bold>\<box>\<^sub>p" *)
lemma dC_15_a: "\<lfloor>(\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<box>\<^sub>a avd A \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd B \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (\<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>a obd avd B\<rfloor>" oops
lemma dC_15_b: "\<lfloor>(\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<box>\<^sub>p pvd A \<^bold>\<and> \<^bold>\<diamond>\<^sub>p pvd B \<^bold>\<and> \<^bold>\<diamond>\<^sub>p pvd (\<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>p obd pvd B\<rfloor>" oops
...
lemma dII_3_1: "((\<lfloor>\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle>\<rfloor>) \<and> (\<exists>x. Z(x) \<and> A(x) \<and> B(x))) \<longrightarrow> obd (Z)(A \<^bold>\<rightarrow> B)" 
  proof 
    assume "(\<lfloor>\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle>\<rfloor>) \<and> (\<exists>x. Z(x) \<and> A(x) \<and> B(x))"
     hence "obd (\<lambda>z. A z \<and> Z z) (\<lambda>z. A z \<and> Z z \<and> B z)" oops
     hence "obd (\<lambda>z. Z z \<and> A z) (\<lambda>z. Z z \<and> A z \<and> B z)" oops
     hence "obd Z (\<lambda>w. (Z w \<and> \<not>(Z w \<and> A w)) \<or> (Z w \<and> A w \<and> B w))" oops
     from this show  L19: "obd (Z)(A \<^bold>\<rightarrow> B)" oops*)
...
lemma obs_II_4_1_c_3: "\<lfloor>\<^bold>\<diamond>(\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle>) \<^bold>\<rightarrow> \<^bold>\<box>(\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle>)\<rfloor>"  by simp
...
lemma dobs_II_4_2_2: "\<lfloor>\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<rightarrow> \<^bold>O obd \<^bold>\<langle>(A \<^bold>\<rightarrow> B)\<^bold>|\<^bold>\<top>\<^bold>\<rangle>\<rfloor>" sledgehammer oops
lemma dobs_II_4_2_3: "\<lfloor>(\<^bold>O obd \<^bold>\<langle>(A \<^bold>\<rightarrow> B)\<^bold>|\<^bold>\<top>\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<box>\<^sub>a avd \<^bold>\<top> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (A \<^bold>\<rightarrow> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (\<^bold>\<not>(A \<^bold>\<rightarrow> B))) \<^bold>\<rightarrow> \<^bold>O\<^sub>a obd avd (A \<^bold>\<rightarrow> B)\<rfloor>" oops
lemma dobs_II_4_2_4: "\<lfloor>\<^bold>\<box>\<^sub>a avd \<^bold>\<top>\<rfloor>" by simp
lemma dobs_II_4_2_5: "\<lfloor>(\<^bold>O obd \<^bold>\<langle>(A \<^bold>\<rightarrow> B)\<^bold>|\<^bold>\<top>\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (A \<^bold>\<rightarrow> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (\<^bold>\<not>(A \<^bold>\<rightarrow> B))) \<^bold>\<rightarrow> \<^bold>O\<^sub>a obd avd (A \<^bold>\<rightarrow> B)\<rfloor>" try
lemma dobs_II_4_2_6: "\<lfloor>(\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (A \<^bold>\<and> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (A \<^bold>\<and> \<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>a obd avd (A \<^bold>\<rightarrow> B)\<rfloor>"  try 
lemma dobs_II_4_2_6_p: "\<lfloor>(\<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>p pvd (A \<^bold>\<and> B) \<^bold>\<and> \<^bold>\<diamond>\<^sub>p pvd (A \<^bold>\<and> \<^bold>\<not>B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>p obd pvd (A \<^bold>\<rightarrow> B)\<rfloor>"  try  

lemma dOa_C: "\<lfloor>\<^bold>\<diamond>\<^sub>a avd (A \<^bold>\<and> B) \<^bold>\<and> \<^bold>O\<^sub>a obd avd A \<^bold>\<and> \<^bold>O\<^sub>a obd avd B \<^bold>\<rightarrow>  \<^bold>O\<^sub>a obd avd (A \<^bold>\<and> B)\<rfloor>" try
lemma dOp_C: "\<lfloor>\<^bold>\<diamond>\<^sub>p pvd (A \<^bold>\<and> B) \<^bold>\<and> \<^bold>O\<^sub>p obd pvd A \<^bold>\<and> \<^bold>O\<^sub>p obd pvd B \<^bold>\<rightarrow>  \<^bold>O\<^sub>p obd pvd (A \<^bold>\<and> B)\<rfloor>" try
lemma dOa_DD: "\<lfloor>(\<^bold>O\<^sub>a obd avd A \<^bold>\<and> \<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>a avd (A \<^bold>\<and> B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>a ob av (A \<^bold>\<and> B)\<rfloor>" try
declare [[smt_timeout=300]]
lemma dOp_DD: "\<lfloor>(\<^bold>O\<^sub>p obd pvd A \<^bold>\<and> \<^bold>O obd \<^bold>\<langle>B\<^bold>|A\<^bold>\<rangle> \<^bold>\<and> \<^bold>\<diamond>\<^sub>p pvd(A \<^bold>\<and> B)) \<^bold>\<rightarrow> \<^bold>O\<^sub>p obd pvd (A \<^bold>\<and> B)\<rfloor>" try
end